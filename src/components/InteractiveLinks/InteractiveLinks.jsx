...
function InteractiveLinks() {
  const links = [
    ...
    { id: 'storybook', path: '/post/storybook', title: 'my life storybook - COMING SOON', text: '...briefly sums up my previous life journey until 2021 when my life changed radically.', icon: iconStorybook }
  ];
